    ...
    return (
        <div className="container mx-auto px-5 h-screen mt-8">
            <form className='border shadow-sm w-full md:w-4/6 mx-auto p-10'>
                ...
                <div className='mb-5'>
                    <label className='block mb-2 text-xl text-gray-600 cursor-pointer' htmlFor="confirmPassword">Confirem Password</label>
                    <input type="text" placeholder="Confirm Password" id="confirmPassword" className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                    focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400"/>
                </div>
